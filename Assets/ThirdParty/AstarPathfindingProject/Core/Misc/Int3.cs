...
namespace Pathfinding
{
    ...
    public struct Int3 : System.IEquatable<Int3>
    {
        ...
        private static Fix64 floatPrecision = 1000F;
        public static float FloatPrecision { get { return floatPrecision.AsFloat(); } }

        /// <summary>1 divided by <see cref="Precision"/></summary>
        private static Fix64 precisionFactor = 0.001F;
        public static float PrecisionFactor { get { return precisionFactor.AsFloat(); } }
        ...
        public static Int3 operator *(Int3 lhs, Fix64 rhs)
        {
            lhs.x = FixMath.Round(lhs.x * rhs).AsInt();
            lhs.y = FixMath.Round(lhs.y * rhs).AsInt();
            lhs.z = FixMath.Round(lhs.z * rhs).AsInt();
        ...
        {
            Fix64 cos = Dot(lhs, rhs) / ((Fix64)lhs.Magnitude * (Fix64)rhs.Magnitude);

            cos = cos < -1 ? -1 : (cos > 1 ? 1 : cos);
            return FixMath.Acos(cos).AsFloat();
        }
        ...
        public float Magnitude
        {
            get
            {
                ...
                return (FixMath.Sqrt(_x * _x + _y * _y + _z * _z)).AsFloat();
            }
        }
        ...
        public float SqrMagnitude
        {
            get
            {
                ...
                Fix64 _y = y;
                Fix64 _z = z;
                return (_x * _x + _y * _y + _z * _z).AsFloat();
            }
        }
