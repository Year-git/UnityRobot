...
public class SplineTrailRenderer : MonoBehaviour
{
    ...
    private void RenderMesh()
    {
        ...
        for (int i = (nbQuad - 1) * NbTriIndexPerQuad; i < maxInstanciedTriCount; i++)
        {
            if (i < triangles.Length)
            {
                triangles[i] = 0;
            }
        } //clear a few tri ahead
