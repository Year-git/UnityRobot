...
namespace TencentMobileGaming
{
	public class QAVPTT : ITMGPTT
	{
		...
		public override int StartRecordingWithStreamingRecognition(string filePath, string language)
		{
			return QAVNative.QAVSDK_PTT_StartRecordingWithStreamingRecognition(mNativeObj, filePath, language, s_OnStreamingRecognitionComplete);
		}
