...
namespace TencentMobileGaming
{
	public class QAVNative
	{
		...
		public static extern int QAVSDK_AVContext_EnterRoom(IntPtr avcontext, [MarshalAs(UnmanagedType.LPStr)] string roomID, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] byte[] authBuffer, int authBufferLen,
			...
			QAVOnRoomTypeChangedEvent onRoomtypeChangeEvent, QAVOnDeviceStateChangedEvent onDeviceStateChangedEvent,QAVAudioReadyCallback audioReadyCallback);
		[DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int QAVSDK_AVContext_ExitRoom(IntPtr avcontext);
		[DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int QAVSDK_AVContext_SetAdvanceParams(IntPtr avptt,[MarshalAs(UnmanagedType.LPStr)]string KeyCode,[MarshalAs(UnmanagedType.LPStr)]string value);
        ...
        [DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int QAVSDK_AVAudioCtrl_SetKaraokeType(IntPtr context, int type);
		[DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
		...
		[DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
        public static extern int QAVSDK_AVAudioCtrl_InitSpatializer(IntPtr avaudioctrl, [MarshalAs(UnmanagedType.LPStr)] string modelPath);
        [DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
		...
		[DllImport(MyLibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int QAVSDK_PTT_StartRecordingWithStreamingRecognition(IntPtr avptt, [MarshalAs(UnmanagedType.LPStr)] string filePath, [MarshalAs(UnmanagedType.LPStr)] string language, QAVStreamingRecognitionCallback callback);
        #endregion
    }
}
