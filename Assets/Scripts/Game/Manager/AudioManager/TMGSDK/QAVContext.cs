	...
	public class QAVContext : ITMGContext
	{
		...
		public override int EnterRoom(string roomID, ITMGRoomType roomtype, byte[] authBuffer)
        {
			return QAVNative.QAVSDK_AVContext_EnterRoom(mNativeObj, roomID, authBuffer, authBuffer.Length, (int)roomtype, 0, 0,
				...
				QAVContext.s_QAVOnRoomTypeChangedEvent, QAVContext.s_OnDeviceStateChangedEvent,QAVContext.s_OnAudioReady);
        }
		...
		public override int SetAdvanceParams(string KeyCode,string value){
			return QAVNative.QAVSDK_AVContext_SetAdvanceParams(mNativeObj,KeyCode,value);
		}
