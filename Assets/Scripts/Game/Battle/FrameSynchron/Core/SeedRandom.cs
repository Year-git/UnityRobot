...
public class SeedRandom
{
    ...
    // Class FixRandom generates random numbers
    ...
    /**
    *  @brief Static instance of {@link FixRandom} with seed 1.
    **/
    public static SeedRandom instance;

    internal static void Init(int seed = 1)
    {
        instance = New(seed);
    }
    ...
    **/
    public static SeedRandom New(int seed)
    {
    ...
    **/
    ...
    /**
    *  @brief Returns a {@link Fix64} between a min value [inclusive] and a max value [inclusive].
    **/
    ...
    **/
    ...
    /**
    *  @brief Returns a {@link Fix64} between 0.0 [inclusive] and 1.0 [inclusive].
    **/
    ...
    **/
    public static FixVector3 InsideUnitSphere
    {
        get
        {
            return new FixVector3(Value, Value, Value);
        }
    }
