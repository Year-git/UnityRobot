...
public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
{
    ...
    {
        var clampedL = ClampSinValue(x._serializedValue, out bool flipHorizontal, out bool flipVertical);
    ...
    public static Fix64 Acos(Fix64 x)
    {
        if (x < -One || x > One)
        {
            throw new ArgumentOutOfRangeException("Must between -Fix64.One and Fix64.One", "x");
        }
