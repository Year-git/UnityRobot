...
public struct FixMatrix
{
    ...
    public FixVector3 EulerAngles
    {
        get
        {
            ...
            {
                x = FixMath.Atan2(M32, M33) * Fix64.Rad2Deg,
                y = FixMath.Atan2(-M31, FixMath.Sqrt(M32 * M32 + M33 * M33)) * Fix64.Rad2Deg,
                z = FixMath.Atan2(M21, M11) * Fix64.Rad2Deg
            };
            return result * -1;
        }
    }
    ...
    public static FixMatrix CreateFromLookAt(FixVector3 position, FixVector3 target)
    {
        LookAt(target - position, FixVector3.up, out FixMatrix result);
        return result;
    }

    public static FixMatrix LookAt(FixVector3 forward, FixVector3 upwards)
    {
        LookAt(forward, upwards, out FixMatrix result);
    ...
    {
        FixMatrix.Multiply(ref value1, ref value2, out FixMatrix result);
        return result;
    }
    #endregion
    ...
    public static FixMatrix AngleAxis(Fix64 angle, FixVector3 axis)
    {
        CreateFromAxisAngle(ref axis, angle, out FixMatrix result);
        return result;
    }
    #endregion
