...
public struct FixQuaternion
{
    ...
    {
        FixQuaternion.Add(ref quaternion1, ref quaternion2, out FixQuaternion result);
        return result;
    }

    public static FixQuaternion LookRotation(FixVector3 forward)
    {
        return CreateFromMatrix(FixMatrix.LookAt(forward, FixVector3.up));
    }
    ...
    {
        FixQuaternion.Multiply(ref value1, ref value2, out FixQuaternion result);
        return result;
    }
    #endregion
    ...
    public static FixQuaternion operator +(FixQuaternion value1, FixQuaternion value2)
    {
        FixQuaternion.Add(ref value1, ref value2, out FixQuaternion result);
        return result;
    }
    #endregion
    ...
    public static FixQuaternion operator -(FixQuaternion value1, FixQuaternion value2)
    {
        FixQuaternion.Subtract(ref value1, ref value2, out FixQuaternion result);
        return result;
    }
    #endregion
    ...
    //添加FixQuaternion和Quaternion之间的转换
    public static explicit operator Quaternion(FixQuaternion fixQuaternion)
    {
        return new Quaternion((float)fixQuaternion.x,(float)fixQuaternion.y,(float)fixQuaternion.z,(float)fixQuaternion.w);
    }

    public static implicit operator FixQuaternion(Quaternion quaternion)
    {
        return new FixQuaternion(quaternion.x,quaternion.y,quaternion.z,quaternion.w);
    }
}