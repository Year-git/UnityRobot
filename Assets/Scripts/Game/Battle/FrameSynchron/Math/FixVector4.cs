...
public struct FixVector4
{
    ...
    {
        FixVector4.Min(ref value1, ref value2, out FixVector4 result);
        return result;
    }
    ...
    {
        FixVector4.Max(ref value1, ref value2, out FixVector4 result);
        return result;
    }
    ...
    {
        FixVector4.Multiply(ref value1, value2, out FixVector4 result);
        return result;
    }
    #endregion
    ...
    {
        FixVector4.Multiply(ref value2, value1, out FixVector4 result);
        return result;
    }
    #endregion
    ...
    public static FixVector4 operator /(FixVector4 value1, Fix64 value2)
    {
        FixVector4.Divide(ref value1, value2, out FixVector4 result);
        return result;
    }
    ...
    //添加FixVector4和Vector4之间的转换
    public static explicit operator Vector4(FixVector4 fixVector4)
    {
        return new Vector4((float)fixVector4.x,(float)fixVector4.y,(float)fixVector4.z,(float)fixVector4.w);
    }

    public static implicit operator FixVector4(Vector4 vector4)
    {
        return new FixVector4(vector4.x,vector4.y,vector4.z,vector4.w);
    }
}