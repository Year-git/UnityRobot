...
public struct FixMatrix4x4
{
    ...
    {
        FixMatrix4x4.Multiply(ref value1, ref value2, out FixMatrix4x4 result);
        return result;
    }
    ...
    public static FixMatrix4x4 Translate(FixVector3 translation)
    {
    ...
    /// <returns>The scaling matrix.</returns>
    public static FixMatrix4x4 Scale(Fix64 xScale, Fix64 yScale, Fix64 zScale, FixVector3 centerPoint)
    {
        FixMatrix4x4 result;
    ...
    /// <returns>The scaling matrix.</returns>
    public static FixMatrix4x4 Scale(FixVector3 scales)
    {
    ...
    /// <param name="centerPoint">The center point.</param>
    /// <returns>The scaling matrix.</returns>
    public static FixMatrix4x4 Scale(FixVector3 scales, FixVector3 centerPoint)
    {
    ...
    /// <param name="centerPoint">The center point.</param>
    /// <returns>The scaling matrix.</returns>
    public static FixMatrix4x4 Scale(Fix64 scale, FixVector3 centerPoint)
    {
    ...
    public static FixMatrix4x4 AngleAxis(Fix64 angle, FixVector3 axis)
    {
        AxisAngle(ref axis, angle, out FixMatrix4x4 result);
        return result;
    }
    ...
    {
        TRS(transform.localPosition, transform.localRotation, transform.localScale, out TSMatrix4x4 result);
        return result;
    }*/
}